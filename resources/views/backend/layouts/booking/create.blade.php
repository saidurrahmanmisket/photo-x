                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('kiosk_id') is-invalid @enderror" id="kiosk_id" name="kiosk_id" required>
                                        ...
                                        @foreach($kiosks as $kiosk)
                                            <option value="{{ $kiosk->id }}" {{ old('kiosk_id') == $kiosk->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('payment_type') is-invalid @enderror" id="payment_type" name="payment_type" required>
                                        ...
                                        <option value="vendor" {{ old('payment_type') == 'vendor' ? 'selected' : '' }}>Vendor (Limited Prints)</option>
                                        <option value="user" {{ old('payment_type') == 'user' ? 'selected' : '' }}>User (Fixed Amount)</option>
                                    </select>
                                    @error('payment_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3" id="print_limit_div" style="display: none;">
                                    ...
                                    <input type="number" class="form-control @error('print_limit') is-invalid @enderror" 
                                           id="print_limit" name="print_limit" value="{{ old('print_limit', $vendorLimit) }}" min="1">
